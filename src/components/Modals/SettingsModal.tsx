    ...
    <div className='text-white z-40'>
      ...
      >
        <div className='flex min-h-screen items-center justify-center px-4'>
          ...
          <div className='my-8 inline-block min-w-full transform rounded-[13px] text-left transition-all bg-overlay-3 md:min-w-[420px] shadow-level4 shadow-lg p-0 bg-blue-900 w-[600px] !overflow-visible opacity-100 scale-100'>
            {/* setting header */}
                ...
                <div className='w-[170px]'>
                  <div className='relative'>
                    <button
                      ...
                      className='flex cursor-pointer items-center rounded px-3 py-1.5 text-left focus:outline-none whitespace-nowrap bg bg-blue-500 hover:bg-dark-fill-2 active:bg-dark-fill-3 w-full justify-between'
                      type='button'
                    >
                      {fontSize}
                      <BsChevronDown />
                    ...
                    {settings.dropdownIsOpen && (
                      <ul
                        className='absolute mt-1 max-h-56 overflow-auto rounded-lg p-2 z-50 focus:outline-none shadow-lg   w-full bg-blue-500'
                        style={{
                          filter:
