...
const ProblemDescription: React.FC<ProblemDescriptionProps> = ({
  ...
  return (
    <div className='bg-white'>
      {/* TAB */}
      <div className='flex h-11 w-full items-center pt-2 bg-gradient-to-t from-slate-800 to-blue-900 text-blue-900 overflow-x-hidden'>
        <div
          className={
            "bg-white text-blue-900 font-medium rounded-t-[5px] px-5 py-[10px] shadow-xl text-xs cursor-pointer"
          }
        >
          Description
        </div>
        ...
        <div className='px-5'>
          ...
          <div className='w-full'>
            <div className='flex space-x-4'>
              <div className='flex-1 mr-2 text-lg text-blue-900 font-medium'>
                {problem.title}
              </div>
            </div>
              ...
              {problem.examples.map((example, index) => (
                <div key={example.id}>
                  ...
                  <div className='example-card'>
                    <pre>
                      <strong className='text-blue-900'>Input: </strong>{" "}
                      {example.inputText}
                      <br />
            ...
            <div className='my-5 pb-4'>
              ...
              <ul className='text-blue-900 ml-5 list-disc'>
                <div
